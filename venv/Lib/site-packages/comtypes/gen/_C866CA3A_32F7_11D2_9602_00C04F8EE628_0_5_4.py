...
__all__ = [
    ...
    'SpeechVisemeType', 'SpTextSelectionInformation',
    'ISpeechPhraseInfo', 'SPINTERFERENCE_NOISE',
    'DISPID_SPIProperties', 'DISPID_SOTGetDescription',
    'SpeechTokenIdUserLexicon', 'DISPID_SRCEStartStream',
    'DISPID_SPRuleParent', 'SVP_8', 'SpPhoneticAlphabetConverter',
    'SREAudioLevel', 'SpeechDataKeyLocation',
    'SPINTERFERENCE_NOSIGNAL',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SPIRule',
    'ISpeechAudioStatus', 'DISPID_SVStatus',
    'ISpStreamFormatConverter', 'ISpPhrase',
    'SSSPTRelativeToCurrentPosition', 'SGRSTTTextBuffer',
    'DISPID_SRCEEndStream', 'DISPID_SpeechAudio',
    'SAFTCCITT_ALaw_22kHzStereo', 'ISpGrammarBuilder',
    'DISPID_SRGetFormat', 'DISPID_SpeechLexiconWords', 'SPBO_NONE',
    'SpWaveFormatEx', 'IEnumSpObjectTokens',
    'DISPID_SPEAudioTimeOffset', 'SpStream', 'SpeechTokenShellFolder',
    'DISPID_SpeechXMLRecoResult', 'SAFTADPCM_8kHzMono',
    'SP_VISEME_18', 'DISPID_SOTCreateInstance', 'DISPID_SPIElements',
    'DISPID_SPRulesCount', 'ISpeechXMLRecoResult',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SOTsItem',
    '_ISpeechRecoContextEvents', 'SPXRO_SML', 'SPEI_RESERVED6',
    'SVF_None', 'ISpeechDataKey', 'DISPID_SVSLastStreamNumberQueued',
    'SPAR_Unknown', 'SGDisplay', 'SpInprocRecognizer',
    'eLEXTYPE_PRIVATE19', 'DISPID_SRRAudio', 'DISPID_SDKOpenKey',
    'DISPID_SpeechAudioFormat', 'SECFEmulateResult',
    'SGDSActiveWithAutoPause', 'SRATopLevel', 'eLEXTYPE_PRIVATE10',
    'SVSFUnusedFlags', 'DISPID_SRGReset', 'SAFTADPCM_11kHzMono',
    'SECFNoSpecialChars', 'ISpSerializeState', 'SSFMCreate',
    'SWPKnownWordPronounceable',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'eLEXTYPE_USER',
    'SPEI_TTS_PRIVATE', 'SPWT_LEXICAL', 'SPEI_PROPERTY_STRING_CHANGE',
    'SRADefaultToActive', 'SWPUnknownWordUnpronounceable',
    'SPLO_STATIC', 'SPSNotOverriden', 'SREPropertyNumChange',
    'DISPID_SPRuleEngineConfidence', 'SP_VISEME_15', 'SVEViseme',
    'SPEI_FALSE_RECOGNITION', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'ISpeechPhraseReplacement', 'SPWT_PRONUNCIATION',
    'SpeechVoicePriority', 'DISPID_SGRSTPropertyId',
    'SAFT11kHz16BitMono', 'ISpAudio', 'SpSharedRecoContext',
    'DISPID_SVEPhoneme', 'DISPID_SGRClear', 'SpCustomStream',
    'SpeechDiscardType', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SRCEPhraseStart', 'SFTSREngine',
    'DISPID_SpeechAudioStatus', 'ISpeechPhraseAlternate',
    'SPEI_SR_PRIVATE', 'DISPID_SREmulateRecognition',
    'DISPID_SLGetPronunciations', 'ISpEventSink', 'SECFIgnoreWidth',
    ...
    'DISPID_SVEBookmark', 'DISPID_SPIAudioSizeTime',
    'SAFT12kHz8BitStereo', 'DISPID_SVVolume', 'SVP_4',
    'SPGS_DISABLED', 'SPEI_RESERVED2', 'DISPID_SLPType',
    'DISPID_SOTCId', 'DISPID_SLAddPronunciation',
    'DISPID_SRCEAdaptation', 'SPSInterjection', 'DISPID_SFSClose',
    'DISPID_SWFESamplesPerSec', 'SPEI_RESERVED1', 'SVP_9',
    'SpSharedRecognizer', 'SPRST_INACTIVE',
    'DISPID_SPERequiredConfidence', 'SSTTTextBuffer', '_SPAUDIOSTATE',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPPs_NewEnum',
    'DISPID_SGRsFindRule', 'SPEI_INTERFERENCE', 'SGRSTTEpsilon',
    'SpeechSpecialTransitionType', 'SPBO_AHEAD',
    'ISpeechPhraseElements', 'DISPID_SLWWord', 'DISPID_SPEsItem',
    'SLODynamic', 'ISpeechRecoResultTimes', 'DISPID_SRIsUISupported',
    'DISPID_SABufferNotifySize', 'SVSFParseSapi', 'SPBO_PAUSE',
    'SINoise', 'SPAO_RETAIN_AUDIO', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SpeechPhraseBuilder', 'ISpeechBaseStream',
    'SPPS_SuppressWord', 'SP_VISEME_21', 'SRESoundStart',
    'DISPID_SpeechPhraseElement', 'SAFT16kHz16BitMono',
    ...
    'ISpeechCustomStream', 'SSFMOpenForRead', 'SAFT48kHz16BitMono',
    'SAFT32kHz16BitStereo', 'SPPS_Modifier',
    'SpeechVoiceSkipTypeSentence', 'SVPNormal', 'ISpObjectWithToken',
    'DISPID_SRSSupportedLanguages', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SRRDiscardResultInfo', 'IInternetSecurityManager',
    'STSF_AppData', 'DISPID_SRSClsidEngine', 'DISPID_SOTCategory',
    'DISPID_SRCPause', 'SP_VISEME_20', 'SAFTADPCM_44kHzMono',
    'SPINTERFERENCE_NONE', 'SPCT_SLEEP', 'DISPID_SRRGetXMLErrorInfo',
    'SREStreamEnd', 'SPPS_Noun', 'ISpeechRecoResultDispatch',
    'SpeechGrammarTagUnlimitedDictation', 'SVP_12',
    'DISPID_SPIStartTime', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SVSFNLPMask', 'SDTReplacement', 'SPWORDLIST', 'SRESoundEnd',
    'DISPID_SVRate', 'DISPID_SGRInitialState', 'SAFT12kHz16BitStereo',
    'SPGRAMMARSTATE', 'DISPID_SASCurrentSeekPosition', 'SITooLoud',
    'DISPID_SRProfile', 'DISPID_SVPriority', 'SVP_21',
    'DISPID_SVEWord', 'ISpNotifySource', 'ISpRecoContext2',
    'SpeechVisemeFeature', 'DISPID_SBSFormat', 'eWORDTYPE_DELETED',
    'SVSFVoiceMask', 'SVP_3', 'SPEI_RESERVED3',
    'DISPID_SpeechDataKey', 'SGSDisabled', 'DISPID_SGRSTransitions',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPRST_INACTIVE_WITH_PURGE',
    'STSF_LocalAppData', 'SP_VISEME_4', 'DISPID_SPAsCount',
    'ISpRecoGrammar', 'SPRECOGNIZERSTATUS', 'SpeechUserTraining',
    'DISPIDSPRG', 'SDKLDefaultLocation', 'DISPID_SpeechVoiceEvent',
    'DISPID_SpeechPhraseRule', 'DISPID_SADefaultFormat',
    'SDKLCurrentUser', 'DISPID_SLWsItem', 'ISpMMSysAudio',
    'SPVPRI_ALERT', 'SASStop', 'SAFT22kHz16BitStereo',
    'eLEXTYPE_RESERVED7', 'SPSERIALIZEDPHRASE', 'DISPID_SMSAMMHandle',
    'DISPID_SRRAudioFormat', 'SpMMAudioOut',
    'SpeechRecoProfileProperties', 'DISPID_SRCRecognizer',
    'DISPID_SPEEngineConfidence', 'DISPID_SRGState', 'DISPID_SGRsAdd',
    'SP_VISEME_8', 'SPPS_Function', 'eLEXTYPE_PRIVATE9', 'UINT_PTR',
    'SVP_19', 'DISPID_SRCEFalseRecognition',
    'DISPID_SRGetPropertyString', 'SASPause', 'SVESentenceBoundary',
    'DISPID_SRGCmdSetRuleState', 'SPEI_PHRASE_START',
    'SPEI_SR_BOOKMARK', 'SPEVENTENUM', 'SVP_1',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SREPrivate',
    'ISpResourceManager', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SPDKL_DefaultLocation', 'SpeechCategoryAudioOut',
    'SVEStartInputStream', 'SpeechStreamFileMode',
    'DISPID_SMSADeviceId', 'DISPID_SpeechCustomStream',
    ...
    'SPCT_SUB_DICTATION', 'ISpDataKey', 'SPDATAKEYLOCATION',
    'SVSFIsXML', 'ISpeechObjectTokens', 'ISpRecoResult', 'SINoSignal',
    'SVEEndInputStream', 'SpeechAudioFormatType',
    'ISpeechVoiceStatus', 'DISPID_SOTGetAttribute',
    'SPEI_SENTENCE_BOUNDARY', 'SpeechStreamSeekPositionType',
    'DISPID_SRCERequestUI', 'SPINTERFERENCE_TOOSLOW',
    'SpeechPropertyResponseSpeed', 'SPBO_TIME_UNITS',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SpeechRecoResult', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SRSCurrentStreamPosition',
    'SpeechDisplayAttributes', 'SpeechTokenKeyUI', 'DISPID_SPPsItem',
    'SPSHORTCUTTYPE', 'ISpPhraseAlt', 'ISpRecognizer3', 'SRAONone',
    'SpeechRecognitionType', 'SAFT32kHz16BitMono',
    'SPINTERFERENCE_TOOFAST', 'SREStateChange',
    'SPEI_START_INPUT_STREAM', 'DISPID_SRGCmdSetRuleIdState',
    'SAFTDefault', 'DISPID_SpeechRecoResult2', 'DISPID_SVSpeak',
    'SRTExtendableParse', 'SP_VISEME_12', 'SPSNoun', 'SPPS_RESERVED2',
    'DISPID_SVWaitUntilDone', 'SpeechAddRemoveWord',
    'DISPID_SABufferInfo', 'DISPID_SPRuleName', 'SPEI_TTS_BOOKMARK',
    'SPRST_ACTIVE', 'SPSEMANTICERRORINFO', 'ISpeechLexiconWord',
    'ISpeechPhraseRules', 'SP_VISEME_1', 'DISPID_SGRSRule',
    'ISpeechPhraseRule', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SRGRecoContext', 'SpeechMicTraining', 'ISpShortcut',
    'SPSHT_NotOverriden', 'SpeechCategoryVoices',
    'DISPID_SRAudioInputStream', 'ISpPhoneticAlphabetConverter',
    'DISPID_SVESentenceBoundary',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SLGetGenerationChange', 'DISPID_SRCRetainedAudio',
    'ISpeechPhraseInfoBuilder', 'ISpeechAudioFormat',
    'SPCONTEXTSTATE', 'DISPID_SDKEnumKeys', 'DISPID_SOTRemove',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SPEAudioStreamOffset', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPIGetText', 'SPCT_DICTATION', 'SPCT_SUB_COMMAND',
    'SpUnCompressedLexicon', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SRGCmdLoadFromObject', 'SRTEmulated', 'SPAR_High',
    'SP_VISEME_0', 'SDKLLocalMachine', 'SDA_Two_Trailing_Spaces',
    'Speech_StreamPos_RealTime', 'SLTApp', 'DISPID_SGRAttributes',
    'DISPID_SLPSymbolic', 'DISPID_SpeechGrammarRule', 'SWTAdded',
    'DISPID_SpeechObjectTokens', 'SpeechRegistryUserRoot', 'SAFTText',
    'SPRECOSTATE', 'ISpeechObjectTokenCategory', 'DISPID_SMSALineId',
    'SPRST_NUM_STATES', 'SPPS_RESERVED1', 'SVP_17',
    'DISPID_SPELexicalForm', 'ISpeechLexiconPronunciation',
    'SREFalseRecognition', 'SDTAudio', 'SpeechPropertyAdaptationOn',
    'DISPID_SRCBookmark', 'DISPID_SPRDisplayAttributes',
    'DISPID_SPAStartElementInResult', '_RemotableHandle',
    'SPSHT_EMAIL', 'DISPID_SFSOpen', 'SpeechGrammarState',
    'SpeechBookmarkOptions', 'ISpeechAudio',
    'DISPID_SGRSTPropertyValue', 'SRCS_Enabled',
    'SpeechPropertyNormalConfidenceThreshold', 'SGPronounciation',
    'DISPID_SOTCDefault', 'DISPID_SRGDictationLoad', 'SLTUser',
    'SDA_One_Trailing_Space', 'DISPID_SRCCreateGrammar',
    'eLEXTYPE_PRIVATE12', 'IInternetSecurityMgrSite', 'ISpLexicon',
    'SRSEIsSpeaking', 'DISPID_SGRsItem', 'tagSTATSTG',
    'DISPID_SPRsItem', 'SVEVoiceChange', 'SRTAutopause',
    'DISPID_SPEActualConfidence', 'DISPID_SVSInputWordPosition',
    'DISPID_SVSVisemeId', 'SGDSInactive', 'SpeechTokenContext',
    'DISPID_SPRuleConfidence', 'SPPS_Noncontent', 'SPAUDIOSTATE',
    'DISPID_SWFEBlockAlign', 'DISPID_SGRAddState', 'SVP_20',
    'SVPOver', 'DISPID_SPRuleId', 'SP_VISEME_14', 'SpVoice',
    'SRTStandard', 'STSF_FlagCreate', 'SGDSActive', 'SASClosed',
    'ISpXMLRecoResult', 'SpFileStream', 'DISPID_SGRSTsCount',
    'SAFTCCITT_uLaw_8kHzStereo', 'SP_VISEME_13', 'ISpeechGrammarRule',
    'DISPID_SVGetAudioOutputs', 'SpeechLexiconType', 'SPSHT_Unknown',
    'STCAll', 'SAFTExtendedAudioFormat', 'SpNullPhoneConverter',
    'SAFT44kHz16BitStereo', 'SPEI_REQUEST_UI',
    'DISPID_SPRules_NewEnum', 'DISPID_SRRPhraseInfo',
    'SpeechRuleState', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SGRSTNextState', 'SAFTADPCM_11kHzStereo', 'SPAO_NONE',
    'DISPID_SGRSTPropertyName', 'ISpRecoContext',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpeechRecognizerStatus',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SVEViseme',
    'SPRECOCONTEXTSTATUS', 'SRCS_Disabled',
    'DISPID_SOTMatchesAttributes', 'SPEI_RECO_STATE_CHANGE',
    'SPEI_VISEME', 'SPPS_Verb', 'SPCT_COMMAND',
    'SpeechGrammarTagDictation', 'SPPARTOFSPEECH',
    'DISPID_SPISaveToMemory', 'SPEVENT',
    'DISPID_SpeechPhraseReplacements', 'SAFTGSM610_22kHzMono',
    'SRSActiveAlways', 'SFTInput', 'SPEI_MAX_TTS', 'DISPID_SGRSTType',
    'eLEXTYPE_PRIVATE5', 'DISPID_SOTDataKey', 'SSFMCreateForWrite',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPWORDTYPE',
    'DISPID_SRGetPropertyNumber', 'DISPID_SRGCommit',
    'SRERecoOtherContext', 'SpeechRunState',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SpeechPhraseProperties',
    'DISPID_SGRSTWeight', 'SPCATEGORYTYPE',
    'SpeechTokenKeyAttributes', 'SPEI_HYPOTHESIS', 'DISPID_SRGRules',
    'SBONone', 'ISpeechFileStream', 'DISPID_SVResume', 'SRSEDone',
    'DISPIDSPTSI', 'SPGRAMMARWORDTYPE', 'SECHighConfidence',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPEI_WORD_BOUNDARY', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SpeechBaseStream', 'SPFILEMODE', 'SPEI_MAX_SR',
    'SPBOOKMARKOPTIONS', 'DISPID_SVSLastResult',
    'DISPID_SPRuleChildren', 'DISPID_SpeechPhraseRules',
    'DISPID_SASCurrentDevicePosition', 'ISpObjectTokenCategory',
    'DISPID_SGRSTs_NewEnum', 'SRSInactiveWithPurge', 'SSTTDictation',
    'DISPID_SVEAudioLevel', 'DISPID_SVEStreamEnd', 'SPBINARYGRAMMAR',
    'ISpeechRecoContext', 'SAFTNoAssignedFormat', 'SPDKL_CurrentUser',
    'SPAS_RUN', 'ISpeechRecoResult', 'SPXMLRESULTOPTIONS',
    'DISPID_SpeechMMSysAudio', 'ISpRecoGrammar2',
    'DISPID_SWFEBitsPerSample', 'DISPID_SDKEnumValues',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPCS_ENABLED',
    'DISPID_SAEventHandle', 'SDA_No_Trailing_Space',
    'SAFT48kHz16BitStereo', 'DISPID_SRRGetXMLResult',
    'SPEVENTSOURCEINFO', 'DISPID_SpeechPhraseInfo',
    'DISPID_SPILanguageId', 'SPPROPERTYINFO', 'SP_VISEME_16',
    'DISPID_SPIRetainedSizeBytes', 'SRSActive', 'SPRS_ACTIVE',
    'SVSFParseAutodetect', 'SAFT8kHz8BitStereo', 'IEnumString',
    'SAFT16kHz16BitStereo', 'SRAExport', 'SpeechVoiceSpeakFlags',
    'SPWF_INPUT', 'SPWORDPRONUNCIATION', 'DISPID_SBSRead',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SVAudioOutputStream',
    'DISPID_SpeechLexicon', 'DISPID_SPRFirstElement', 'SGSExclusive',
    'SAFT22kHz16BitMono', 'SPEI_RESERVED5', 'ISpeechVoice',
    'SPEI_MIN_SR', 'SP_VISEME_9', 'SPXRO_Alternates_SML',
    'SSTTWildcard', 'eLEXTYPE_USER_SHORTCUT', 'SVEPhoneme', 'IStream',
    'ISpeechGrammarRules', 'DISPIDSPTSI_ActiveOffset',
    'SAFTNonStandardFormat', 'DISPID_SPCPhoneToId',
    'SpeechPropertyLowConfidenceThreshold',
    'SpeechDictationTopicSpelling', 'SPPS_RESERVED4',
    'SAFTADPCM_22kHzMono', 'DISPID_SLRemovePronunciation',
    'DISPIDSPTSI_SelectionLength', 'eLEXTYPE_PRIVATE15',
    'DISPID_SLPLangId', 'SAFT44kHz8BitMono', 'SDTRule',
    'SPEI_SR_RETAINEDAUDIO', 'eLEXTYPE_RESERVED10',
    'DISPID_SRGetRecognizers', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SRDisplayUI', 'SREAdaptation', 'DISPID_SDKGetStringValue',
    'SpAudioFormat', 'eLEXTYPE_PRIVATE14', 'SGRSTTWildcard',
    'DISPID_SpeechPhraseProperty', 'DISPID_SVGetAudioInputs',
    'SAFTGSM610_8kHzMono', 'SDKLCurrentConfig', 'SpInProcRecoContext',
    'DISPID_SCSBaseStream', 'SPSModifier', 'SpeechPartOfSpeech',
    'DISPID_SRRTStreamTime', 'DISPID_SPRuleFirstElement',
    'ISpNotifySink', 'DISPID_SRSCurrentStreamNumber', 'SP_VISEME_19',
    'SAFT8kHz16BitStereo', 'DISPID_SPPId', 'SDTPronunciation',
    'DISPIDSPTSI_SelectionOffset', 'SVP_15', 'SpMMAudioEnum',
    'DISPID_SAFType', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SVSRunningState', 'SPEI_SOUND_END', 'SPEI_MIN_TTS',
    'DISPID_SRCESoundEnd', 'DISPID_SPCIdToPhone', 'SREPhraseStart',
    'DISPID_SpeechMemoryStream', 'ISpeechRecognizer',
    'DISPID_SpeechRecognizer', 'DISPID_SRRRecoContext', 'SPFM_CREATE',
    'SITooSlow', 'DISPID_SAVolume', 'SBOPause', 'SGLexical',
    'DISPID_SPRs_NewEnum', 'DISPID_SOTCSetId',
    'DISPID_SVSCurrentStreamNumber', 'SAFT11kHz8BitStereo',
    'SAFTCCITT_uLaw_22kHzMono', 'SpObjectTokenCategory',
    'DISPID_SPRsCount', 'DISPID_SLWs_NewEnum',
    'SPINTERFERENCE_TOOLOUD', 'SpeechRecognizerState',
    'SpeechTokenValueCLSID', 'SpeechEngineProperties', 'SPAS_CLOSED',
    'DISPID_SPIGetDisplayAttributes', 'SVEAllEvents',
    'DISPID_SLPs_NewEnum', 'DISPID_SRCreateRecoContext',
    'ISpeechAudioBufferInfo', 'SAFTADPCM_22kHzStereo', 'SPWT_DISPLAY',
    'DISPID_SOTId', 'DISPID_SVSyncronousSpeakTimeout',
    'SPEI_START_SR_STREAM', 'DISPID_SRSetPropertyNumber',
    'SPSERIALIZEDRESULT', 'DISPID_SRIsShared', 'SVSFIsNotXML',
    'SAFTGSM610_11kHzMono', 'SPINTERFERENCE', 'DISPID_SABIEventBias',
    'SpeechGrammarWordType', 'SPSUnknown', 'DISPID_SPEAudioSizeTime',
    'SpeechFormatType', 'ISpeechTextSelectionInformation',
    'SPGS_EXCLUSIVE', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SGRsCount', 'DISPID_SWFEExtraData', 'SP_VISEME_11',
    'DISPID_SRCEBookmark', 'DISPID_SMSSetData', 'ISpeechMMSysAudio',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SPRNumberOfElements',
    'SDTProperty', 'SPSMF_UPS', 'DISPID_SVSPhonemeId',
    'SpeechEngineConfidence', 'DISPID_SPIEngineId',
    'DISPID_SpeechFileStream', 'DISPID_SAFGuid',
    'DISPID_SASNonBlockingIO', 'SPPHRASEELEMENT', 'WAVEFORMATEX',
    'SpeechTokenKeyFiles', 'eLEXTYPE_PRIVATE13',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SP_VISEME_3',
    'DISPID_SVSpeakStream', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SRCEventInterests', 'DISPID_SpeechPhoneConverter',
    'SAFT11kHz8BitMono', 'eLEXTYPE_PRIVATE3', 'SVSFDefault',
    'SPAR_Medium', 'SAFT48kHz8BitStereo', 'DISPID_SGRsCommit',
    'SVF_Emphasis', 'SREInterference', 'SAFT32kHz8BitMono',
    'SPFM_OPEN_READONLY', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SRGSetWordSequenceData', 'eLEXTYPE_PRIVATE1',
    'SpPhoneConverter', 'SpeechPropertyResourceUsage',
    'SSSPTRelativeToStart', 'DISPID_SRCEPropertyNumberChange',
    'SPWF_SRENGINE', 'SVP_18', 'DISPID_SRRecognizer',
    'DISPID_SVDisplayUI', 'SPEI_SOUND_START', 'DISPID_SLPsItem',
    'SPPHRASEREPLACEMENT', 'eLEXTYPE_PRIVATE11', 'SPCS_DISABLED',
    'SVF_Stressed', 'DISPID_SPRText', 'SpMMAudioIn', 'SP_VISEME_5',
    'DISPID_SLWPronunciations', 'SpPhraseInfoBuilder',
    'DISPID_SRGDictationUnload', 'SPWORDPRONOUNCEABLE',
    'DISPID_SPPName', 'DISPID_SVGetVoices', 'SLOStatic',
    'DISPID_SPPFirstElement', 'DISPID_SPEPronunciation',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SRCESoundStart',
    'SpeechAudioFormatGUIDText', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SVPause', 'DISPID_SPPNumberOfElements',
    'SAFT24kHz8BitMono', 'SPGS_ENABLED', 'SPSFunction',
    'DISPID_SpeechWaveFormatEx', 'ISpObjectToken', 'SVSFParseSsml',
    'eLEXTYPE_APP', 'SP_VISEME_17', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SABIBufferSize', 'DISPID_SRCSetAdaptationData',
    'DISPID_SRCEAudioLevel', 'SPDKL_LocalMachine',
    'DISPID_SASetState', 'SPEI_END_SR_STREAM', 'DISPID_SMSGetData',
    'SpeechWordPronounceable', 'SpeechCategoryAppLexicons',
    'DISPID_SpeechRecoContext', 'DISPID_SPIAudioStreamPosition',
    'SPLO_DYNAMIC', 'DISPID_SOTCEnumerateTokens', 'SPRULE',
    'SPEI_VOICE_CHANGE', 'eLEXTYPE_RESERVED4', 'eLEXTYPE_PRIVATE18',
    'SPFM_NUM_MODES', 'ISpeechLexiconPronunciations',
    'DISPID_SPAsItem', 'DISPID_SGRSAddWordTransition',
    'ISpeechObjectToken', 'DISPID_SRCEInterference',
    'SpeechRuleAttributes', 'SpeechAudioState', 'DISPID_SGRName',
    'SPVPRI_OVER', 'SPRS_INACTIVE', 'ISpeechPhraseProperties',
    'eLEXTYPE_PRIVATE16', 'SITooQuiet', 'eWORDTYPE_ADDED',
    'SPPS_NotOverriden', 'SPAS_STOP', 'SPWORD', 'SAFT8kHz8BitMono',
    'SpeechInterference', 'DISPID_SpeechVoiceStatus',
    'SpeechAudioProperties', 'DISPID_SRGIsPronounceable',
    'SPSEMANTICFORMAT', 'SREHypothesis', 'DISPID_SLWsCount',
    'DISPID_SpeechPhraseElements', 'DISPID_SPPEngineConfidence',
    'SAFT16kHz8BitStereo', 'DISPID_SpeechGrammarRuleState',
    'ISpeechResourceLoader', 'SVP_10', 'Speech_Max_Word_Length',
    'SGSEnabled', 'DISPID_SpeechObjectToken', 'SAFT12kHz8BitMono',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SRCState', 'SPVPRIORITY',
    'DISPID_SOTs_NewEnum', 'SpShortcut', 'SPSVerb',
    'SECLowConfidence', 'SPVPRI_NORMAL', 'ISequentialStream',
    'SPEI_PHONEME', 'DISPID_SPEsCount', 'SPSHT_OTHER',
    'DISPID_SPEDisplayAttributes',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPRECORESULTTIMES',
    'SAFT22kHz8BitMono', 'DISPID_SWFEFormatTag',
    'DISPID_SVSInputSentenceLength', 'DISPID_SOTsCount',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SPAs_NewEnum', 'SPAUDIOSTATUS', 'ISpVoice',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRCResume',
    'eLEXTYPE_RESERVED8', 'SPPS_Unknown', 'SP_VISEME_6',
    'SPRULESTATE', 'LONG_PTR', 'DISPID_SOTIsUISupported',
    'DISPID_SPEAudioSizeBytes', 'ISpeechPhraseAlternates', 'SDTAll',
    'ISpStreamFormat', 'STCInprocHandler', 'SVSFPersistXML',
    'ISpeechPhoneConverter', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SVEStreamStart',
    'DISPID_SDKGetBinaryValue', 'DISPID_SRGSetTextSelection',
    'SpMemoryStream', 'STSF_CommonAppData',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SVEAudioLevel',
    'SpeechWordType', 'DISPID_SRCERecognition',
    'SpeechRetainedAudioOptions', 'DISPID_SVSkip', 'SVSFNLPSpeakPunc',
    'SGRSTTDictation', 'DISPID_SVSLastBookmarkId', 'SRAImport',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SLGenerationId',
    'DISPID_SpeechLexiconPronunciation', 'SREStreamStart',
    'DISPID_SDKDeleteValue', 'STCLocalServer',
    'DISPID_SASFreeBufferSpace', 'SpeechRecoContextState',
    'DISPID_SVSpeakCompleteEvent', 'SPEI_UNDEFINED',
    'SpeechRecoEvents', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SRRSetTextFeedback', 'SPFM_OPEN_READWRITE',
    'SPFM_CREATE_ALWAYS', 'SRSInactive', 'DISPID_SVAudioOutput',
    'tagSPPROPERTYINFO', 'SVP_13', 'ISpeechPhraseReplacements',
    'SAFT16kHz8BitMono', 'SREAllEvents', 'SITooFast',
    'DISPID_SRRSpeakAudio', 'SVP_6', 'Speech_StreamPos_Asap',
    'Speech_Max_Pron_Length', 'SAFTADPCM_44kHzStereo', 'SINone',
    'DISPID_SRGDictationSetState', 'SPRST_ACTIVE_ALWAYS',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SLPsCount', 'SVP_2',
    'SVEBookmark', 'SDTLexicalForm', 'SpeechEmulationCompareFlags',
    'DISPID_SVEVoiceChange', 'SpeechVoiceEvents',
    'SpeechCategoryRecognizers', 'DISPID_SVVoice', 'SVSFParseMask',
    'DISPID_SPAPhraseInfo', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SGRsCommitAndSave', 'SPAR_Low', 'SWTDeleted',
    'DISPID_SRAudioInput', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPACommit', 'DISPID_SRSetPropertyString', 'SP_VISEME_2',
    'SP_VISEME_10', 'DISPID_SDKSetLongValue',
    'DISPID_SABIMinNotification', 'ISpRecoCategory',
    'SPSSuppressWord', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SRCERecognizerStateChange', 'SVPAlert',
    'SSSPTRelativeToEnd', 'SAFT11kHz16BitStereo',
    'DISPID_SLPPartOfSpeech', 'SVP_16', 'ISpRecognizer',
    'DISPID_SLWLangId', 'SSFMOpenReadWrite', 'SDTDisplayText',
    'SPLOADOPTIONS', 'STCRemoteServer', 'DISPID_SVEventInterests',
    'SDA_Consume_Leading_Spaces', 'SPPS_LMA', 'SpCompressedLexicon',
    'SRERequestUI', 'DISPID_SRRSaveToMemory', 'DISPID_SAStatus',
    'DISPID_SRRTTickCount', 'DISPID_SWFEChannels', 'SRERecognition',
    'SGRSTTRule', 'DISPID_SpeechVoice', 'DISPID_SGRsDynamic',
    'DISPID_SRRTimes', 'eLEXTYPE_PRIVATE2', 'ISpeechLexicon',
    'SRAORetainAudio', 'ISpeechLexiconWords',
    'DISPID_SpeechRecoContextEvents', 'SAFTGSM610_44kHzMono',
    'DISPID_SPRulesItem', 'DISPID_SRCEHypothesis',
    'ISpeechPhraseElement', 'SpResourceManager', 'ISpEventSource',
    'SPPHRASEPROPERTY', 'DISPID_SVGetProfiles',
    'DISPID_SAFGetWaveFormatEx', 'SAFT12kHz16BitMono',
    'SWPUnknownWordPronounceable', 'ISpeechPhraseProperty',
    'SAFT48kHz8BitMono', 'SASRun', 'DISPID_SRGCmdLoadFromMemory',
    'SpObjectToken', 'DISPID_SRGId', 'SP_VISEME_7',
    'SAFTCCITT_ALaw_44kHzStereo', 'SRADynamic',
    ...
    'SVEWordBoundary', 'SVP_7', 'ISpNotifyTranslator', 'SECFDefault',
    'SVSFPurgeBeforeSpeak', 'SAFT24kHz8BitStereo',
    'SPWORDPRONUNCIATIONLIST', 'ISpeechGrammarRuleState',
    'DISPID_SPEs_NewEnum', 'DISPID_SRRTLength', 'DISPID_SBSSeek',
    'DISPID_SPARecoResult', 'DISPID_SRSAudioStatus',
    'DISPID_SRCEEnginePrivate', 'DISPID_SPCLangId',
    'SAFT8kHz16BitMono', 'SVP_0', 'ISpeechRecoResult2', 'SPVISEMES',
    'SDTAlternates', 'DISPID_SRCCreateResultFromMemory',
    'ISpeechMemoryStream', 'SPEI_SR_AUDIO_LEVEL',
    'SpeechGrammarTagWildcard', 'SGRSTTWord', 'SVP_14',
    'ISpProperties', 'SPSLMA', 'DISPID_SpeechLexiconWord',
    'DISPID_SVSInputWordLength', 'SPEI_END_INPUT_STREAM',
    'ISpeechWaveFormatEx', 'DISPID_SRState', 'SPEI_ADAPTATION',
    'eLEXTYPE_VENDORLEXICON', 'SpeechAllElements',
    'ISpeechGrammarRuleStateTransitions', 'SPTEXTSELECTIONINFO',
    'DISPID_SRSNumberOfActiveRules', 'SAFTADPCM_8kHzStereo',
    'DISPID_SVIsUISupported', 'ISpeechRecoGrammar',
    'SAFT44kHz16BitMono', 'SpeechAudioFormatGUIDWave',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SVSLastBookmark', 'SRTReSent',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SGRSTsItem',
    'DISPID_SLGetWords', 'eLEXTYPE_PRIVATE6', 'eLEXTYPE_PRIVATE8',
    'ISpRecognizer2', 'SPVOICESTATUS',
    'DISPID_SVSInputSentencePosition', 'SPSTREAMFORMATTYPE',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SOTSetId',
    'DISPID_SOTGetStorageFileName', 'DISPID_SGRs_NewEnum',
    '_ISpeechVoiceEvents', 'SPDKL_CurrentConfig', 'SREBookmark',
    'SVEPrivate', 'DISPID_SRCRequestedUIType',
    '__MIDL_IWinTypes_0009', 'DISPID_SDKCreateKey', 'DISPID_SBSWrite',
    'eLEXTYPE_PRIVATE17', 'DISPID_SPPConfidence',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPPsCount',
    'STCInprocServer', 'DISPID_SpeechPhraseAlternate',
    'SAFT44kHz8BitStereo', 'DISPID_SpeechLexiconProns',
    'ISpPhoneticAlphabetSelection', 'SPEI_RECOGNITION',
    'SAFT24kHz16BitStereo', 'SRAInterpreter', 'DISPID_SOTCGetDataKey',
    'SPAUDIOOPTIONS', 'DISPID_SOTDisplayUI', 'DISPID_SASState',
    'SECNormalConfidence', 'DISPID_SRCVoice', 'SAFT22kHz8BitStereo',
    'DISPID_SpeechGrammarRules', 'DISPID_SVAlertBoundary',
    'SPWAVEFORMATTYPE', 'DISPID_SPPValue',
    'SpeechCategoryPhoneConverters', 'DISPID_SPEDisplayText',
    'SVP_11', 'SpLexicon', 'eLEXTYPE_RESERVED9',
    'DISPID_SDKDeleteKey', 'SECFIgnoreKanaType', 'SRTSMLTimeout',
    'DISPID_SVEEnginePrivate', 'SPADAPTATIONRELEVANCE',
    'ISpPhoneConverter', 'SPAUDIOBUFFERINFO',
    'SpStreamFormatConverter', 'SVSFlagsAsync',
    'DISPID_SPIEnginePrivateData', 'DISPID_SPIReplacements',
    'DISPID_SPPChildren', 'DISPID_SGRId', 'SPPS_RESERVED3',
    'SREPropertyStringChange', 'Speech_Default_Weight',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SGRAddResource',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SGDSActiveUserDelimited',
    'SPLEXICONTYPE', 'SVP_5', 'SGLexicalNoSpecialChars',
    'DISPID_SDKSetStringValue', 'SAFT24kHz16BitMono', 'SPAS_PAUSE',
    'SpNotifyTranslator', 'SPPHRASERULE', 'SRARoot',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SDKGetlongValue',
    'DISPID_SLPPhoneIds', 'SPPHRASE',
    'DISPID_SLRemovePronunciationByPhoneIds', 'eLEXTYPE_RESERVED6',
    'eLEXTYPE_PRIVATE20', 'SAFTCCITT_ALaw_22kHzMono',
    'SpeechCategoryAudioIn', 'SpeechAudioVolume',
    'SpeechPropertyComplexResponseSpeed', 'SAFT32kHz8BitStereo',
    'DISPID_SLWType', 'DISPID_SPIGrammarId', 'SPPS_Interjection',
    'SECFIgnoreCase'
]

_check_version('1.1.14', 1610637402.090740)
